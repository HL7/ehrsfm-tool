...
namespace R4C_EHRSFM_EA_AddIn
{
    public class Main
    {
                ...
                switch (ItemName)
                {
                    ...
                    case "Quick Access Tab":
                        if (view_ctrl == null || !view_ctrl.Visible)
                        {
                            ...
                            view_ctrl = (QuickAccessControl)Repository.AddTab("EHR-S FM", "R4C_EHRSFM_EA_AddIn.QuickAccessControl");
                    ...
                    case "FM Browser Tab":
                        if (mb_ctrl == null || !mb_ctrl.Visible)
                        {
                            ...
                            mb_ctrl = (ModelBrowserControl)Repository.AddTab("FM Browser", "R4C_EHRSFM_EA_AddIn.ModelBrowserControl");
        ...
        {
            if (Properties.Resources.OUTPUT_NM_EHRSFM.Equals(TabName) && ID != -1)
            {
