...
dotnet run compile /app/import-scripts/input/ehrs_fm_r2_1-2022APR.max /app/import-scripts/output/dhfp-profiledefinition.max /app/publication/source/dhfp.max
