    ...
    class R2Importer
    {
        ...
        public void import(EA.Repository Repository, EA.Package rootPackage, string xmlFileName)
        {
            ...
            foreach (Link clink in consequenceLinks.Values)
            {
                ...
                {
                    Repository.WriteOutput(Properties.Resources.OUTPUT_NM_EHRSFM, String.Format("ConsequenceLink from {0} to {1}, target Function not found.", clink.sourceID, clink.targetID), -1);
                }
            }
            ...
            foreach (Link slink in seeAlsoLinks.Values)
            {
                ...
                {
                    Repository.WriteOutput(Properties.Resources.OUTPUT_NM_EHRSFM, String.Format("SeeAlso link from {0} to {1}, target Function not found.", slink.sourceID, slink.targetID), -1);
                }
            }
            ...
            foreach (Link composition in compositions.Values)
            {
                ...
                else
                {
                    ...
                    if (sectionColor == null)
                    {
                        Repository.WriteOutput(Properties.Resources.OUTPUT_NM_EHRSFM, String.Format("Function composition from {0} to {1}, target not found.", composition.sourceID, composition.targetID), -1);
                    }
                }
            }
            progress.Close();
        ...
        private bool addComposition(string sourceID, string targetID)
        {
            ...
            {
                Repository.WriteOutput(Properties.Resources.OUTPUT_NM_EHRSFM, String.Format("Function {0} composition to {1}, already there", sourceID, targetID), -1);
                return false;
            }
            else
            {
        ...
        private bool addConsequenceLink(string sourceID, string targetID, string notes)
        {
            ...
            {
                Repository.WriteOutput(Properties.Resources.OUTPUT_NM_EHRSFM, String.Format("Function {0} link to {1}, already there", sourceID, targetID), -1);
                return false;
            }
            else
            {
        ...
        private bool addSeeAlsoLink(string sourceID, string targetID)
        {
            ...
            {
                Repository.WriteOutput(Properties.Resources.OUTPUT_NM_EHRSFM, String.Format("Function {0} see-also to {1}, already there", sourceID, targetID), -1);
                return false;
            }
            else
            {
